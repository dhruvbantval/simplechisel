...
import { getFolder, getFolders, pollJob, startGenerate } from '../../data/api'
    ...
    return (
      <Section title="Tests">
        <EmptyState
          ...
          hint="Generating tests runs the riscv-dv generator on a backend (cosim/webapp/server.py). Start it, or set VITE_API_BASE to a running instance, to build test folders here."
        />
      </Section>
    )
  }
