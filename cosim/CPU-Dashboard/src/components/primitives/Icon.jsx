/*
 * One consistent inline-SVG icon set with fixed, token-driven sizing. Keeps icon
 * weight and dimensions uniform across the app (the skill flags inconsistent icon
 * sizing). All icons inherit currentColor and use a 24-viewBox / 1.8 stroke.
 */
